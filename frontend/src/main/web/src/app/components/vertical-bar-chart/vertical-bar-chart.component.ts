...
export class VerticalBarChartComponent implements OnInit {
  ...
  constructor(elementRef: ElementRef, d3Service: D3Service, artifactImagesService: ArtifactImagesService) {
  ...
  private createYearBuckets(data: Location[]): [number, number][] {
  ...
  private initBarChart(data: [number, number][]) {
    ...
    chart.append("g")
      .attr("class", "brush")
      .call(d3.brushX()
        .extent([[0, 0], [width, height]]).on("brush", () => {
